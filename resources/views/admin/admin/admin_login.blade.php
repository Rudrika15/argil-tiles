...
<link href="{{ asset('assetbackend/css/bootstrap.min.css') }}" rel="stylesheet">
<link href="{{ asset('assetbackend/css/all.css') }}" rel="stylesheet">
...
<div class="auth-form login-form">
	<div class="form-header text-center">
	 <div class="logo">
	  <a href="#"><img src="{{ asset('assetbackend/images/logo.png')}}" height="50px" alt=""></a>
	 </div>
