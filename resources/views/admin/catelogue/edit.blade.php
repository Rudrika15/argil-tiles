...
<div class="main-content">
  ...
  <form class="form-group" enctype="multipart/form-data" action="{{route('catelogue.editcode')}}" method="post">
    @csrf
    <input type="hidden" name="id" value="{{$data->id}}">
    <div class="form-label-group">
      <input id="form_firstname" type="text" name="title" value="{{$data->title}}" class="form-control" placeholder="First Name" required>
