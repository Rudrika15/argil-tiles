        ...
        <form class="form-group" enctype="multipart/form-data" action="{{ route('lvtstore') }}" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input id="name" type="text" name="names" class="form-control" placeholder="Names"
                            required>
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="primarycolors" class="form-control"
                            placeholder="Primarycolors" required>
                        <label for="form_firstname">Primarycolors</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="edges" class="form-control" placeholder="Edges"
                            required>
                        <label for="form_firstname">Edges</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="clicktype" class="form-control"
                            placeholder="Clicktype" required>
                        <label for="form_firstname">Clicktype</label>
                    </div>


                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="shadeVariation" class="form-control"
                            placeholder="Shadevariation" required>
                        <label for="form_firstname">Shadevariation</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="backingType" class="form-control"
                            placeholder="backingtype" required>
                        <label for="form_firstname">Backingtype</label>
                    </div>


                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="style" class="form-control" placeholder="Style"
                            required>
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="wearLayer" class="form-control"
                            placeholder="Wearlayer" required>
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input id="form_firstname" accept='image/*' onchange="readURL(this,'#img1')" type="file"
                            name="mainImg" class="form-control" placeholder="Main Img" required>
                    ...
                    <img src="{{ url('slider/image_default.png') }}" alt="Main Image" id="img1"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('slider/image_default.png') }}" alt="Sub-Img1" id="img2"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('slider/image_default.png') }}" alt="Sub-Img2" id="img3"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('slider/image_default.png') }}" alt="Sub-Img3" id="img4"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('slider/image_default.png') }}" alt="Sub-Img4" id="img5"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('slider/image_default.png') }}" alt="Sub-Img5" id="img6"
                        style='height:150px;width:100px' class="mt-2">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2" id="imagepreview">
                    <img id="ogImagePreview" src="{{ asset('slider/image_default.png') }}" alt="Og Image"
