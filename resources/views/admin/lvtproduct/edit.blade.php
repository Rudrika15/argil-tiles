            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="names" value="{{ $data->names }}"
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="primarycolors" value="{{ $data->primarycolors }}"
                            class="form-control" placeholder="Primarycolors" required>
                        <label for="form_firstname">Primarycolors</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="edges" value="{{ $data->edges }}"
                            class="form-control" placeholder="Edges" required>
                        <label for="form_firstname">Edges</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="clicktype" value="{{ $data->clicktype }}"
                            class="form-control" placeholder="Clicktype" required>
                        <label for="form_firstname">Clicktype</label>
                    </div>


                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="shadeVariation" value="{{ $data->shadeVariation }}"
                            class="form-control" placeholder="Shadevariation" required>
                        <label for="form_firstname">Shadevariation</label>
                    </div>

                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="backingType" value="{{ $data->backingType }}"
                            class="form-control" placeholder="backingtype" required>
                        <label for="form_firstname">Backingtype</label>
                    </div>


                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="style" value="{{ $data->style }}"
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="text" name="wearLayer" value="{{ $data->wearLayer }}"
                            class="form-control" placeholder="Wearlayer" required>
                    ...
                    <div class="form-label-group">
                        <select name="bookmatch" id="bookmatch" class="form-control" required>
                            ...
                            @foreach ($lvtsize as $lvtsize)
                                <option
                                    value="{{ $lvtsize->size }}"{{ $lvtsize->size == $data->bookmatch ? 'selected' : '' }}>
                                    {{ $lvtsize->size }}</option>
                            @endforeach
                ...
                <div class="col-md-6">
                    <div class="form-label-group">
                        <input id="form_firstname" accept='image/*' onchange="readURL(this,'#img1')" type="file"
                            name="mainImg" class="form-control" placeholder="Main Img">
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="file" name="subImg1" accept='image/*'
                            onchange="readURL(this,'#img2')" class="form-control" placeholder="subImg1">
                    ...
                    <div class="form-label-group">
                        <input id="form_firstname" type="file" name="subImg2" accept='image/*'
                            onchange="readURL(this,'#img3')" class="form-control" placeholder="subImg2">
                        <label for="form_firstname">SubImg2</label>
                    </div>

                    <div class="form-label-group">
                        <input accept='image/*' onchange="readURL(this,'#img4')" id="form_firstname" type="file"
                            name="subImg3" class="form-control" placeholder="subImg3">

                        <label for="form_firstname">SubImg3</label>
                    </div>

                    <div class="form-label-group">
                        <input accept='image/*' onchange="readURL(this,'#img5')" id="form_firstname" type="file"
                            name="subImg4" class="form-control" placeholder="subImg4">
                        <label for="form_firstname">SubImg4</label>
                    </div>

                    <div class="form-label-group">
                        <input accept='image/*' onchange="readURL(this,'#img6')" id="form_firstname" type="file"
                            name="subImg5" class="form-control" placeholder="subImg5">

                        <label for="form_firstname">SubImg5</label>
                    </div>


                    <img src="{{ url('spc') }}/{{ $data->mainImg }}" alt="Main Image" id="img1"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('spc') }}/{{ $data->subImg1 }}" alt="Sub-Img1" id="img2"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('spc') }}/{{ $data->subImg2 }}" alt="Sub-Img2" id="img3"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('spc') }}/{{ $data->subImg3 }}" alt="Sub-Img3" id="img4"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('spc') }}/{{ $data->subImg4 }}" alt="Sub-Img4" id="img5"
                        style='height:150px;width:100px' class="mt-2">
                    <img src="{{ url('spc') }}/{{ $data->subImg5 }}" alt="Sub-Img5" id="img6"
                        style='height:150px;width:100px' class="mt-2">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2" id="imagepreview">
                    <img id="ogImagePreview"
                        src="{{ !empty($metablogs) && !empty($metablogs->ogImage) ? asset('ogimage/' . $data1->ogImage) : asset('slider/image_default.png') }}"
                ...
                <div class="col">
                    <div class="form-label-group">
                        <input type="text" class="form-control" id="metadescription" placeholder=""
                            name="metadescription" value="{{ $data1->description ?? '' }}">
