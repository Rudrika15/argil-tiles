...
<div class="main-content">
	...
	<form class="form-group" enctype="multipart/form-data" action="{{route('quartzstore')}}" method="post">
		@csrf
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-label-group">
					<input id="form_firstname" type="text" name="bookmatch" class="form-control" placeholder="Book Match" required>
        ...
        <div class="row mb-4">
            <h4 class="m-3">Add Meta Properties for Quartz Product</h4>
        </div>
