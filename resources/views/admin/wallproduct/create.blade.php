...
<div class="main-content">
	...
	<form class="form-group" enctype="multipart/form-data" action="{{route('wallstore')}}" method="post">
		@csrf
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="form-label-group">
					<input id="form_firstname" list="sizes" type="text" name="size" class="form-control" placeholder="Size" required>
					<datalist id="sizes">
						@foreach($data3 as $data3)
						<option value="{{$data3->size}}">{{$data3->size}}</option>
						@endforeach
				...
				<div class="form-label-group">
					<input id="form_firstname" list="finishtypes" type="text" name="finishType" class="form-control" placeholder="Finish Type" required>
				...
				<div class="form-label-group">
					...
					<datalist id="stocks">
						...
						<option value="{{$data1->stock}}">{{$data1->stock}}</option>
						@endforeach
				...
				<div class="form-label-group">
					<input id="form_firstname" type="text" list="designtypes" name="designType" class="form-control" placeholder="Design Type" required>
