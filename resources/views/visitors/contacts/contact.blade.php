...
<!--End Page Title-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="asset/images/argileimage/contactsimage.png" alt="" class="img-responsive all-page-side-image">
            </div>
            <div class="col-md-6">
                <div class="contact-form-area1">
                    <div class="contact-title">Let's Be in Touch !!!</div>

                    <form id="contact-form" name="contact_form" class="default-form" action="{{ route('send.mail') }}" method="POST">
                        @csrf
                        <div class="row">
                        ...
                        <button type="submit" class="btn-one btn-class2">Request Price Quote</button>
                    </form>
                </div>
            </div>
        </div>
