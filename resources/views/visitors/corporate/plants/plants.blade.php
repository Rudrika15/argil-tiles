...
@section('content')
    ...
    <section class="page-title"
        style="background-image: url('https://www.naveentile.com/wp-content/uploads/2023/07/Manufacturing.png');">
        <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="paragraph text-justify">The best quality Digital tiles are manufactured and delivered to the
                    ...
                    newer ones relating to the brand will always get their choice met from our range. The sizes include 250
                    x 330 mm, 300 x 300 mm, 300 x 450 mm, 200 x 600 mm, 300 x 600 mm. The larger sizes like 200 x 600 & 300
                    x 600 mm are an awesome range and give a feel of grandiose to any wall clad with them. The size gives an
                    impression of pride and power. The smaller sizes are ideal and affordable solution to the large middle
                    class in India and across the world.</p>
                <p class="paragraph text-justify">The Finishes available in the above sizes include High gloss,
                    which replicates mirror finish. Satin, the touch of silk. Rustic, the natural stones revisited. Wooden,
                    bringing thick forests to your home. The above parameters are met by plethora of designs which can be
                    seen in the product catalogs of the company. With Digital printing Technology on our Hands, the company
                    has virtually no limit in the looks and appearances of the tiles. The technology has given designer the
                    flexibility to let their imagination run wild and recreate any look. We have also permitted our bulk
                    buyers as well as design Specialist dealing with us to demand whatever theme or look they desire and we
                    promise to recreate it for them. All these add up to make the biggest range of wall tiles offering in
                    India. The sum total of different SKUs is more than 1000 making this unarguably one of the most wide
            ...
            <div class="col-md-12">
                ...
                <p class="paragraph text-justify">Argil DuraQuartz Surfaces' range of products is manufactured under a
                    ...
                    finish along with flatness. The High Pressure, Vacuum and Vibrating press are inevitable component of
                ...
                <p class="paragraph text-justify">Since its inception, company has been keen on innovation and Research.
                    ...
                    done round the clock. With every testing there is SPC and SQC involved to keep the Production System up
                    to date. Along with the regular activity, we have our researchers working on newer and better product
                    performance designs of the product. They vary parameters of material, production and ageing to test and
                    re-test new ideas. This gives birth to better and improved products over a period of time.The innovation
                ...
                <p class="paragraph text-justify" data-aos="fade-up">Product design is the single most important and market
                    ...
                    fresh looks and trendy designs. We have also collaborated with Spanish and Italian companies for the
                    design know how.The sole role of design department in both the units is to roll out trendy as well as
                    new coming designs that will work in the market. They have a consistent communication with the marketing
                    team who give them new thoughts and demands prevailing in the markets. Based on these, the design teams
                    churn out new designs.Few of all the designs proposed are accepted, as we believe in delivering the
                    best, not everything. The designs are then market tested before commercialization. We make sure that
                    needs of the market are beaten and we are always leader and never copycats. Being pioneers in
                    introduction fresh styles and range of products makes us feel proud.</p>
