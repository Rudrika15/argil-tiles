        ...
        <div class="container">
            <div class="content-box">
                ...
                <div class="bread-crumb">
                    <a href="/">Home &nbsp;<i class="fa fa-angle-right"></i></a> &nbsp;<span>Profile</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="text-justify paragraph">Argil, where we have travelled from Tradition to technology, we feel the
                    journey is growing longer and better with every passing day. We have always respected our traditions
                    and culture and have whole heartedly embraced technology to take us forward without any exceptions.
                    May this journey be never ending and always challenging us to soar greater height of success and
                    achievement. The management of Argil has always accomplished the big goals set out by us together.
                    Unarguably, they have done it with ethics and moral of our community. Throughout their journey they
                    have upheld the principles of sharing the growth with all stakeholders, leaving faces smiling and
                    hearts warm with affection and respect for the brand. I would like to congratulate you on the same
                    and motivate you to always be this humble and serving to your brand and people associated.</p>
            ...
            <div class="col-md-12 ">
                <p class="text-justify paragraph">The employees of the company have learnt the culture of sharing and
                    ...
                    heart and minds, ARGIL has established a sure shot spot. They always demand better products, smarter
                    functionality and exquisite designs to make ARGIL forefront in the market. This is the biggest
                    remuneration they have given us. I thank them for always helping us keep on our toes and never be
                    complacent.</p>
                <p class="text-justify paragraph">The channel partners of ARGIL, retailers, distributors and dealers, have
                    always had faith in the company and the management. Every time we have introduced a new sub brand or a
                    product range they have been eagerly waiting to introduce and promote the same to the customers and
                    prospects. They have maintained good relations with the influencers in their region to instill
                    confidence and faith in the brand. lt is a matterofhonorto have such partners in business. This year,
                    2016, we have set a new goal and a long term vision for the ARGIL GROUP. I am confident that we will
                ...
                <p class="text-justify paragraph">India's greatest entrepreneurial stories are all epics within themselves.
                    ...
                    employed at Parshuram Pottery. The family and the young boy too moved to the place where he would later
                    set up one of the most admired ceramic brands of the world. Shri Amarshibhai too worked in the same
                    factory for 8 to 10 years working in different roles, ranging from a manufacture of glazed jars to
                    plaster turning moulder. He moved on to Junagadh District to serve as a moulder fro 2 years in Kathiawad
                    Industries Ltd. People destined to create history are always blessed with astute vision of things to
                ...
                <p class="text-justify paragraph">With the zeal of an entrepreneur, he returned to Morbi. With numerous
                    ...
                    Tiles Company was formed in 1952. Funding was the biggest challenge as the Family had very little saved.
                ...
                <p class="text-justify paragraph" data-aos="fade-up">Stability is a limiting belief for those with big
                    ...
                    go hand in hand. In the year 2010 the company ahs recently launched Quartz Stone unit. The first of its
                    kind in India, it has the most vibrant product range in the segment. You will read about the company
                    capacities and their product range in the coming sections of the profile.</p>
            </div>
        </div>
    </div>
@endsection
