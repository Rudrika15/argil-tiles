...
@section('content')
    ...
    <section class="py-5 bg-white border-bottom">
        <div class="container py-4">
            <h2 class="fw-bold text-uppercase mb-4 text-center text-md-start">Export Operations to Russia</h2>
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="p-4 bg-light border-start border-4 border-dark">
                        <p class="mb-0 small text-dark">
                            ...
                            Our documentation team ensures all international trade certificates are prepared to meet
                            Russian regulatory and import requirements.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="enquiry" class="py-5 text-white shadow-lg"
        style="background: linear-gradient(rgba(46, 46, 46, 0.8), rgba(0, 0, 0, 0.8)), 
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <form id="contact-form" class="row g-3" method="post"
                        ...
                        @csrf
                        <input type="hidden" name="export_country" value="Russia">
                        <div class="col-md-6">
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="r1" class="accordion-collapse collapse" data-bs-parent="#faqRussia">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    approximately 25–30 days, while delivery to **St. Petersburg** or via Vladivostok
                                    ranges
                                    from 35–45 days depending on the shipping line.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="r2" class="accordion-collapse collapse" data-bs-parent="#faqRussia">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    brittle or
                                    warp during harsh Russian winters or due to internal heating system fluctuations.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="r3" class="accordion-collapse collapse" data-bs-parent="#faqRussia">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    Invoice, Packing List, Bill of Lading, and Certificate of Origin. We ensure all
                                    technical specifications meet the requirements for smooth clearance at Russian
                                    customs.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="r4" class="accordion-collapse collapse" data-bs-parent="#faqRussia">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    popular
                                    for premium kitchen islands and large-scale commercial lobby interiors in Moscow and
                                    St.
                                    Petersburg.
                                </div>
                            </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="r5" class="accordion-collapse collapse" data-bs-parent="#faqRussia">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    SPC
                                    designs and Quartz colors in a single 20ft or 40ft container to maintain a diverse
                                    stock
        ...
        <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the standard delivery time to Russia?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Production typically takes 3–4 weeks. Shipping transit time to Novorossiysk is approximately 25–30 days, while delivery to St. Petersburg or via Vladivostok ranges from 35–45 days depending on the shipping line."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "Do you provide documentation for Russian Customs clearance?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Argil Group provides a comprehensive set of documents including the Commercial Invoice, Packing List, Bill of Lading, and Certificate of Origin. We ensure all technical specifications meet the requirements for smooth clearance at Russian customs."
      }
    },
    {
      "@type": "Question",
      "name": "Are Jumbo Quartz slabs available for Russian interior projects?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Absolutely. We export Jumbo Quartz slabs (3200 x 1600 mm) which are highly popular for premium kitchen islands and large-scale commercial lobby interiors in Moscow and St. Petersburg."
      }
    },
    {
      "@type": "Question",
