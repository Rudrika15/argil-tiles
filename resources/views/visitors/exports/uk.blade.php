...
@section('content')
    ...
    <section class="py-5 bg-white border-bottom">
        <div class="container py-4">
            <h2 class="fw-bold text-uppercase mb-4 text-center text-md-start">Export Operations to UK</h2>
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <div class="p-4 bg-light border-start border-4 border-dark">
                        <p class="mb-0 small text-dark">
                            ...
                            UK regulatory and import requirements post-Brexit.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <form id="contact-form" class="row g-3" method="post"
                        ...
                        @csrf
                        <input type="hidden" name="export_country" value="UK">
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="uk1" class="accordion-collapse collapse" data-bs-parent="#faqUK">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    or
                                    London Gateway** ranges from 28–35 days. We provide consistent tracking updates from
                                    Mundra port to the final UK destination.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="uk4" class="accordion-collapse collapse" data-bs-parent="#faqUK">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    comprehensive documentation, including the Commercial Invoice, Packing List with
                                    EORI
                                    details, and GSP Certificate of Origin to facilitate smooth customs clearance and
                                    potentially reduced duty rates.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="uk5" class="accordion-collapse collapse" data-bs-parent="#faqUK">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    dimensions, we can discuss bespoke thickness or specifications for large-scale UK
                                    commercial contracts and high-end residential developments.
                                </div>
                            </div>
                        </div>
        ...
        <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the transit time to UK ports?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Production typically takes 3–4 weeks. Shipping transit to Felixstowe, Southampton, or London Gateway ranges from 28–35 days. We provide consistent tracking updates from Mundra port to the final UK destination."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How do you handle post-Brexit import documentation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Our export team is well-versed in post-Brexit trade requirements. We provide comprehensive documentation, including the Commercial Invoice, Packing List with EORI details, and GSP Certificate of Origin to facilitate smooth customs clearance and potentially reduced duty rates."
      }
    },
    {
      "@type": "Question",
      "name": "Can we request bespoke sizes for UK architectural projects?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "While we offer standard Jumbo Quartz slabs (3200 x 1600 mm) and standard SPC dimensions, we can discuss bespoke thickness or specifications for large-scale UK commercial contracts and high-end residential developments."
      }
    }
  ]
}
