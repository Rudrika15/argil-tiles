...
@section('content')
    ...
    <section class="py-5 bg-white border-bottom">
        <div class="container py-4">
            <h2 class="fw-bold text-uppercase mb-4 text-center text-md-start">Export Operations to USA</h2>
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <ul class="list-unstyled mb-4">
                        <li class="mb-2 small"><i class="bi bi-check2-circle me-2 text-dark"></i> Technical compliance
                            with ASTM & North American standards</li>
                        <li class="mb-2 small"><i class="bi bi-check2-circle me-2 text-dark"></i> Optimized logistics
                            via Houston, Savannah & Los Angeles</li>
                        <li class="mb-2 small"><i class="bi bi-check2-circle me-2 text-dark"></i> Specialized EPA & CARB
                            Phase 2 compliant formulations</li>
                    </ul>
                    <div class="p-4 bg-light border-start border-4 border-dark">
                        <p class="mb-0 small text-dark">
                            ...
                            Our documentation team ensures all ISF and US Customs requirements are met for
                            smooth delivery to your warehouse.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-4 p-xl-5">
                        ...
                        <table class="table table-sm table-borderless small text-uppercase mb-4">
                            <tr class="border-bottom">
                                ...
                                <td class="py-2 fw-bold text-end">20 mil (0.50mm)</td>
                            </tr>
                            <tr class="border-bottom">
                                <td class="py-2 text-muted">Core Thickness</td>
                                <td class="py-2 fw-bold text-end">5.0mm - 8.0mm</td>
                            </tr>
                            <tr>
                                <td class="py-2 text-muted">Pad</td>
                    ...
                    <div class="p-4 p-xl-5">
                        ...
                        <table class="table table-sm table-borderless small text-uppercase mb-4">
                            <tr class="border-bottom">
                                ...
                                <td class="py-2 fw-bold text-end">126" x 63" (Jumbo)</td>
                            </tr>
                            <tr class="border-bottom">
                                <td class="py-2 text-muted">Thickness</td>
                                <td class="py-2 fw-bold text-end">2cm / 3cm</td>
                            </tr>
                            <tr>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7">
                    <form id="contact-form" class="row g-3" method="post"
                        ...
                        @csrf
                        <input type="hidden" name="export_country" value="USA">
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="u1" class="accordion-collapse collapse" data-bs-parent="#faqUSA">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    is
                                    approximately 35–45 days, while shipping to the **West Coast (Los Angeles/Long
                                    Beach)**
                                    typically takes 25–30 days.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="u3" class="accordion-collapse collapse" data-bs-parent="#faqUSA">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    filing
                                    well in advance. We provide the commercial invoice, packing list, and bill of lading
                                    required by your US customs broker for a seamless entry process.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="u4" class="accordion-collapse collapse" data-bs-parent="#faqUSA">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    the
                                    requirements for high-traffic commercial and premium residential applications as per
                        ...
                        <div class="accordion-item border rounded-0 mb-3 overflow-hidden shadow-sm">
                            ...
                            <div id="u5" class="accordion-collapse collapse" data-bs-parent="#faqUSA">
                                <div class="accordion-body small text-muted bg-white border-top">
                                    ...
                                    specifically designed to meet the demands of American kitchen fabricators for large
                                    islands and seamless countertops.
                                </div>
                            </div>
                        </div>
        ...
        <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What are the transit times to major USA ports?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Production takes 3–4 weeks. Transit time to East Coast ports (Savannah/Newark) is approximately 35–45 days, while shipping to the West Coast (Los Angeles/Long Beach) typically takes 25–30 days."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "Do you provide support for ISF and US Customs clearance?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Absolutely. Our export desk provides all necessary data for your ISF (10+2) filing well in advance. We provide the commercial invoice, packing list, and bill of lading required by your US customs broker for a seamless entry process."
          }
        },
        {
          "@type": "Question",
          "name": "What is the wear layer specification for the US market?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "We typically supply 20 mil (0.50mm) wear layers for the US market, which meets the requirements for high-traffic commercial and premium residential applications as per North American standards."
          }
        },
        {
          "@type": "Question",
          "name": "Can we request Jumbo Quartz slabs in US standard sizes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, we offer Jumbo Slabs (126\" x 63\") in 2cm and 3cm thicknesses. These are specifically designed to meet the demands of American kitchen fabricators for large islands and seamless countertops."
          }
        }
      ]
    }
