...
{{-- <div class="topcontent container d-flex">
    <div class="row">
        <div class="col-md-6">
            ...
            <div>
                <h5>We have always respected our traditions and culture and have whole heartedly embraced technology
        ...
        <div class="col-md-12">
            <h5>The management of Argil has always accomplished the big goals set out by us together. Unarguably, they
                ...
                affection and respect for the brand.</h5>
        </div>
        <div>
            <h5>I would like to congratulate you on the same and motivate you to always be this humble and serving to
...
<div class="productimage">
    <div class="product1"  data-aos="zoom-in-up">
        <img src="asset/images/argileimage/productimage1.jpg" alt="" width="100%">
    </div>
    <div class="product1" data-aos="zoom-in-up">
