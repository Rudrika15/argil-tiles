...
@section('title', 'Engineered Stone Export from India')
@section('meta_description', 'Import premium engineered stone from India. Export-ready, certified slabs for distributors worldwide. Request a quote.')
@section('canonical', 'https://argiltiles.com/quartz-export')
...
@section('content')
    ...
    <section class="text-white text-center py-5 spc-bg-image">
        <div class="container py-5">
            <h1 class="display-4">Premium Engineered Stone – Export-Ready from India</h1>
            <p class="lead mt-3">Durable, stylish, and certified slabs, delivered worldwide for distributors,
                importers, and interior designers.</p>
            <a href="#quote-form" class="btn btn-light btn-lg mt-3">Request Export Quote</a>
            <a href="https://argiltiles.com/pdf/Leaflet-Dura-Quartz.pdf" class="btn btn-outline-light btn-lg mt-3" target="_blank">Download
                Catalog</a>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4 mb-3">
                    ...
                    <h3>ISO Certified</h3>
                    <p>Premium quality engineered stone certified for global standards.</p>
                </div>
                <div class="col-md-4 mb-3">
    ...
    <section class="products py-5 bg-light">
        <div class="container">
            <h2 class="text-center mb-4">Our Surface Collection</h2>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <img src="{{ asset('quartz/' . $product->mainImg) }}" class="card-img-top"
                                alt="{{ \App\Support\SeoCopy::soften($product->name) }}" title="{{ \App\Support\SeoCopy::soften($product->name) }}">

                            <div class="card-body">
                                <h3 class="card-title">{{ \App\Support\SeoCopy::soften($product->name)}}</h3>
            ...
            <a href="https://argiltiles.com/quartzsurface" class="btn btn-primary">View All Products</a>        </div>
        </div>
    </section>
