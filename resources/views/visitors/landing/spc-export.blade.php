...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="hero" style="background: url('{{ asset('asset/images/argileimage/spcproducts3.jpg') }}') center/cover no-repeat;">
        <div class="hero-content">
            <h1>Premium SPC Flooring – Export-Ready from India</h1>
            <p>Durable, stylish, and certified SPC flooring, delivered worldwide for distributors,
                importers, and interior designers.</p>
            <a href="#quote-form" class="cta-btn">Request Export Quote</a>
            <a href="https://argiltiles.com/pdf/CATALOGUE.pdf" class="cta-btn">Download SPC Catalog</a>
        </div>
    </section>
    ...
    <section class="why-us">
        <div class="container">
            <h2>Why International Buyers Choose Argil Group</h2>
            <div class="why-grid">
                <div class="why-item">
                    <h5>ISO Certified</h5>
                    <p>Premium quality SPC flooring certified for global standards.</p>
    ...
    <section class="products">
        <div class="container">
            <h2>Our SPC Flooring Collection</h2>
            <div class="product-grid">
                <div class="product-card">
                    <img src="{{ asset('asset/images/argileimage/spcproducts3.jpg') }}" alt="">
                    <h3>SPC Classic Oak</h3>
                    <p>Thickness: 5mm | Finish: Matte | MOQ: 500 sqm</p>
                    <a href="#quote-form" class="cta-btn">Request Quote</a>
                </div>
    ...
    <section class="process">
        <div class="container">
            <h2>Simple & Transparent Export Process</h2>
            <div class="steps">
                <div class="step">
                    <h5>1. Inquiry</h5>
                </div>
    ...
    <section class="testimonials">
        <div class="container">
            <h2>Trusted by International Buyers</h2>
            <div class="testimonials-grid">
                <div class="testimonial">
                    <p>"Argil Group’s SPC flooring quality is exceptional. Our import orders arrived on time and exceeded
                        expectations."</p>
                    <span>— John Smith, Distributor, UK</span>
                </div>
                <div class="testimonial">
                    <p>"Working with Argil Group for our interior projects was seamless. Their export team made the entire
                        process smooth and reliable."</p>
                    <span>— Sarah Ahmed, Interior Designer, UAE</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Quote Form -->
    <section id="quote-form" class="contact">
        <div class="container">
            <h2>Get Your SPC Export Quote Today</h2>
            <form action="{{ route('spc.export.submit') }}" method="POST">
                @csrf
                ...
                <textarea name="message" placeholder="Message / Product Interest" rows="4"></textarea>
    ...
    <!-- Footer -->
    <footer>
        <p>© 2025 Argil Group. All Rights Reserved. | Designed by <a href="https://flipcodesolutions.com">Flipcode
                Solutions</a></p>
    </footer>
