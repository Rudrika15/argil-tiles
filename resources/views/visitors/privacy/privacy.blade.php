...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="mt-3  ">Philosophy</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Information Collection and Use</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Log Data</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Cookies</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Service Providers</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Security</h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Links to Other Sites</h2 class="mt-3">
                <p class="text-justify">This Service may contain links to other sites. If you
                    ...
                    me. Therefore, I h4 class="mt-3" ly advise you to review the Privacy Policy of these websites. I have
                    no control over
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Children’s Privacy
                </h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Changes to This Privacy Policy
                </h2 class="mt-3">
            ...
            <div class="col-md-12">
                <h2 class="mt-3 ">Contact Us
                </h2 class="mt-3">
                <p class="text-justify">If you have any questions or suggestions about my
                    Privacy Policy, do not
                    hesitate to contact me at <a href="tel:+912822240628" class="text-decoration-none text-black"
                        rel="noopener noreferrer nofollow">+ 91 2822 240628</a>
                </p>
            </div>
        </div>
    </div>
