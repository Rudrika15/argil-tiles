        ...
        <div class="container">
            <div class="content-box">
                ...
                <div class="bread-crumb">
                    <a href="index.html">Home &nbsp;<i class="fa fa-angle-right"></i></a> &nbsp;<span>Privacy</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-justify paragraph">Mahadev built the Argil Ceramics app as a Free app. This SERVICE is
            ...
            <div class="col-md-12">
                <p class="core-heading">Information Collection and Use</p>
                <p class="text-justify paragraph">For a better experience, while using our Service, I may require you to
