...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-112 advantage-card" style="background-color: rgb(31, 31, 31);" data-aos="fade-up">
                    ...
                    <h5>Natural quartz has pores in them. However, the polished surface of artificial stone does not absorb
                        ...
                        longer and look new for years.</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-112 advantage-card" data-aos="fade-up">
                ...
                <h5>The size, quart colours, treatments, and patterns of composite quartz stone are present in a variety of
                    ...
                    existing area. The top choices include Zodiac Black, Zodiac Red, Crystal White, and many others.</h5>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-112 advantage-card" style="background-color: rgb(31, 31, 31);" data-aos="fade-up">
                ...
                <h5>The cost of natural stone might vary depending on the kind, colour, and quality of the stone but is
                    ...
                    in amazing colors and variants</h5>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-112 advantage-card" data-aos="fade-up">
                ...
                <h5>Artificial quartz is as strong and hard as granite, with the benefit of being chip and crack resistant.
                    ...
                    quartz stones last longer and due to their easy maintenance, they look the same for years.</h5>
            </div>
        </div>
    </div>
    </div>
    <div class="container text-center quartz-paragraph">
        ...
        <h5>There are a number of usage and applications of artificial quartz stones which is why they are so much popular
            amongst people. These are</h5>
    </div>
    <div class="container quartz-paragraph">
        <ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <h5 class="bg-imgae-enhance1-para">Finely crushed quartz is combined with resin, stabilising polymers,
                        ...
                        quartz countertops manufacturers in the country with a number of satisfied customers.</h5>
                    <h5 class="bg-imgae-enhance1-para">At Argil, we have the greatest expectations for ourselves. To ensure
            ...
            <div class="row" style="margin-left: 82px">
                <div class="col-lg-3 bg-enhance-card" data-aos="flip-up" style="width: 27rem">
                    ...
                    <h5>The fundamental components of an Argil Tiles Slab, such as Natural Quartz Grits, Resin, colouring
                        agents
                        (traces), and texturizing material, are all thoroughly tested before being combined in huge overhead
                        mixers. It's crucial to remember that all Argil Tile variations and colours are produced using the
                        same
                ...
                <div class="col-lg-3 bg-enhance-card" data-aos="flip-up" style="width: 27rem">
                    ...
                    <h5>Spread onto trays, the mixture is compacted with intense vibration and pressure. The compressed
                        ...
                        before cooling. In this phase, the mixture's resin is activated, combining with the quartz to create
                ...
                <div class="col-lg-3 bg-enhance-card" data-aos="flip-up" style="width: 27rem">
                    ...
                    <h5>Using two sets of parallel diamond saws, the uneven slab's four sides are now cut to the appropriate
                        ...
                        using a multi-head diamond calibration machine. And a multi-head polishing machine is used to polish
                ...
                <div class="col-lg-3 bg-enhance-card" data-aos="flip-up" style="width: 27rem">
                    ...
                    <h5>Every step of the manufacturing process undergoes inspection at Argil Tiles, from selecting the best
                        ...
                        distribution system after they have given their permission.</h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        style="background: white;color:rgb(94, 92, 92);">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body">
                        <h5>Quartz countertops are elegant, practical, and low-maintenance and are composed of bits of
                            quartz held together in an industrial-grade binder. Quartz countertops manufacturers make
                            different varieties of quartz countertops to cater the needs of their customers.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsetwo" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Attractive look and feel, Ease of to maintenance, Availability in a variety of options, Cost
                            effectiveness, and Durability are some of the major advantages of quartz slabs</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsethree" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>The cost and heat resistance of quartz countertops are their major disadvantages. A quartz
                            kitchen counter top can be out of your price range if you're installing worktops on a tight
                            budget. Additionally, heated cookware and appliances can harm quartz countertops.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsefour" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Quartz slabs are perfect for a variety of wonderful home improvements. Quartz is most frequently
                            used for countertops, backsplashes in kitchens, tabletop surfaces, and flooring.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsefive" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Low maintenance is required for quartz slabs and countertops. Look no further if you're unsure
                            of how to maintain your black or white quartz countertops. Quartz is relatively simple to keep
                            clean and maintain. To keep surfaces looking their best, use a soft substance cloth and a
                            moderate cleaning chemical.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsesix" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Quartz slabs are significantly more expensive per square than materials like ceramic and
                            porcelain. Quartz slabs of good quality and depending upon the thickness artificial quartz stone
                            manufacturers in Morbi and rest of India can charge between 200 to 400 Rupees per square foot.
                        </h5>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapseseven" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Quartz slabs and countertops are extremely scratch-resistant; quartz of good quality may
                            withstand regular use without being harmed.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapseeight" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Granite costs more than quartz often. There are several types of low-quality granite that you
                            might get cheaply, but using such a material is not advised.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapsenine" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Both quartz and granite are extraordinarily stunning and durable. Depending on your preferred
                            design and intended use for your countertops or floors, you may select one material over
                            another. Granite is a natural stone, while quartz is man-made. Compared to granite, quartz
                            requires fewer maintenance tasks because it doesn't need to be sealed.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapseten" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Quartz is not easily stained. Quartz tiles and slabs are stain-resistant because of the resin
                            combination used in their construction.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                ...
                <div id="collapseeleven" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Concrete countertops are typically less expensive for homeowners than quartz surfaces. Quartz
                            countertops are more expensive but require little maintenance, making them the more preferred
                            choice.</h5>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsetwel" aria-expanded="true" aria-controls="collapseOne"
                        style="background: white;color:rgb(94, 92, 92);">
                        Is quartz cheaper than marble?
                    </button>
                </h2>
                <div id="collapsetwel" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>Yes. Quartz is frequently less expensive than marble. Natural luxury stones like marble are
                            typically fairly pricey. Quartz countertops can be great for a luxurious aesthetic with a lower
                            price tag because they often cost substantially less.</h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="accordion" id="accordionExample">
            <div class="accordion-item">
                <h2 class="accordion-header" id="headingOne">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        data-bs-target="#collapsethirteen" aria-expanded="true" aria-controls="collapseOne"
                        style="background: white;color:rgb(94, 92, 92);">
                        How should quartz be cleaned?
                    </button>
                </h2>
                <div id="collapsethirteen" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <h5>The best cleaner for quartz slabs or countertops is a blend of warm water and mild detergent,
                            despite the fact that there are numerous secure commercial products on the market. Your quartz
                            surfaces will remain clean with routine cleaning.</h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6" style="margin-left:-160px">
                <div class="contact-form-area">
                    ...
                    <div class="text">
                        <p style="font-size: 20px">Let's Be in Touch !!!</p>
                    </div>
