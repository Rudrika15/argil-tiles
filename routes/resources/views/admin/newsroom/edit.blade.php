...
<div class="main-content">
  ...
  <form class="form-group" enctype="multipart/form-data" action="{{route('newsrooms.editcode')}}" method="post">
    @csrf
    ...
    <div class="form-label-group">
      <textarea id="form_firstname" name="details" class="form-control" required>{{$data->id}}</textarea>
